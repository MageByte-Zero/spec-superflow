...
Converts planning artifacts into a single execution handshake: `execution-contract.md`. Use `../../templates/execution-contract.md` (project-level `templates/`) as the baseline structure.
