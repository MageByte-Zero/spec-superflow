...
3+ failed fixes = architectural problem. Each fix revealing new problems elsewhere = wrong architecture. Record: `node scripts/spec-superflow.mjs state set <change-dir> dp_5_result <decision>`. Discuss with user before attempting more fixes.
